...
namespace Synapse.Client
{
    public class ClientConnectionData
    {
        ...
        // TODO : Remove properly the ClientManager.CentralServer and return a good connection data
        public static ClientConnectionData DecodeJWT(string jwt)
        {
            ...
            var payload = JwtBuilder.Create().DoNotVerifySignature().Decode<ClientConnectionData>(jwt);
            return payload;
        }
    }
}
